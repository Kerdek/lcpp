...
MAIN_INPUTS = main.cpp scanner.cpp tokenizer.cpp gc.cpp string.cpp stringbuf.cpp record.cpp term.cpp read.cpp print.cpp evaluate.cpp abs.cpp app.cpp ref.cpp ext.cpp shr.cpp
MAIN_HEADERS = Makefile strclone.hpp scanner.hpp tokenizer.hpp gc.hpp string.hpp stringbuf.hpp record.hpp term.hpp read.hpp print.hpp evaluate.hpp abs.hpp app.hpp ref.hpp ext.hpp shr.hpp
