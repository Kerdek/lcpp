...
MAIN_INPUTS = main.cpp scanner.cpp tokenizer.cpp MicroGC/gc.cpp string.cpp stringbuf.cpp record.cpp term.cpp read.cpp print.cpp evaluate.cpp eval_stack.cpp abs.cpp app.cpp ref.cpp ext.cpp shr.cpp
MAIN_HEADERS = Makefile strclone.hpp scanner.hpp tokenizer.hpp MicroGC/gc.hpp string.hpp stringbuf.hpp record.hpp term.hpp read.hpp print.hpp evaluate.hpp eval_stack.hpp abs.hpp app.hpp ref.hpp ext.hpp shr.hpp
